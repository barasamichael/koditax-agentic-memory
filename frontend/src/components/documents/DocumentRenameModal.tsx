...
export function DocumentRenameModal({
  ...
  const canSubmit = !loading && trimmedName.length > 0 && trimmedName !== currentName
      ...
      <div className="w-full max-w-md rounded-3xl border border-gray-200 bg-white p-6 shadow-2xl">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <h2 id="document-rename-title" className="mt-1 text-lg font-semibold text-gray-900">
              Rename document
            </h2>
          </div>
          <button
        ...
        <p className="mt-3 text-sm text-gray-500">
          Update the display name shown in the document library and details view.
        </p>
        ...
        {errorMessage ? (
          ...
          <p className="mt-3 text-xs text-gray-500">
            Keep the name human-readable. Internal identifiers never appear here.
          </p>
        )}
